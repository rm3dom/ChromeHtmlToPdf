...
{
  /// <summary>
  ///     Describes the original settings of the <see cref="T:System.Runtime.InteropServices.TYPEFLAGS" /> in the COM
  ///     type library from which the type was imported.
  /// </summary>
  [Flags]
    [ComVisible(true)]
    [Serializable]
    public enum TypeLibTypeFlags
    {
        ...
        ///     that has this attribute. The name of the variable that points to the object is the same as the class name of the
        ///     object.
        /// </summary>
        FPreDeclId = 8,
        ...
        /// <summary>
        ///     Indicates base interfaces should be checked for name resolution before checking child interfaces. This is the
        ///     reverse of the default behavior.
        /// </summary>
