...
namespace ChromeHtmlToPdfLib.EncodingTools.Multilang
{
    ...
    public interface IMLangFontLink : IMLangCodePages
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void GetFontCodePages([In] [ComAliasName("MultiLanguage.wireHDC")]
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void MapFont([In] [ComAliasName("MultiLanguage.wireHDC")]
            ref _RemotableHandle hDC, [In] uint dwCodePages,
            [In] [ComAliasName("MultiLanguage.wireHFONT")]
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void ReleaseFont([In] [ComAliasName("MultiLanguage.wireHFONT")]
            ref _RemotableHandle hFont);
